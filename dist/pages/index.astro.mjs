import { c as createAstro, a as createComponent, d as renderComponent, r as renderTemplate } from '../chunks/astro/server_CQl11rBO.mjs';
import 'kleur/colors';
import { a as $$MainLayout, p as partnersData } from '../chunks/MainLayout_CBIp2-hU.mjs';
import { $ as $$AnnouncementBanner, a as $$HeroSection, h as heroImage, b as $$ClientsSection, c as $$FeaturesGeneral, d as $$FeaturesNavs, t as tools, e as dashboard, f as construction, g as $$TestimonialsSection, i as $$PricingSection, j as $$FAQ, k as $$HeroSectionAlt } from '../chunks/dashboard-image_CpwtfQbR.mjs';
import { f as featureImage } from '../chunks/features-image_vXt4zT1s.mjs';
...
const starterKit = {"name":"Starter Kit","description":"Best option for DIY projects","price":"49","cents":".00","billingFrequency":"USD / monthly","features":["Key hardware tools","Access to guides & tutorials","Standard support"],"purchaseBtnTitle":"Get the Starter Kit","purchaseLink":"#"};
const professionalToolbox = {"name":"Professional Toolbox","description":"Best for large scale uses","price":"89","cents":".00","billingFrequency":"USD / monthly","features":["Premium tool selection","Priority support","Exclusive content & deals","Bulk order discounts"],"purchaseBtnTitle":"Get the Professional Toolbox","purchaseLink":"#"};
const pricing = {
  title,
  subTitle,
  badge,
...
}, "/home/braco/Escritorio/collados/src/pages/index.astro", void 0);

const $$file = "/home/braco/Escritorio/collados/src/pages/index.astro";
const $$url = "";
