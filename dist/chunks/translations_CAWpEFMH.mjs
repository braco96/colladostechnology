import { g as getCollection } from './_astro_content_LqbuJ3W-.mjs';
import i18next from 'i18next';
import * as z from 'zod';
import { i as AstroUserError } from './astro/server_CQl11rBO.mjs';

const starlightConfig = {"social":[{"icon":"github","label":"GitHub","href":"https://github.com/mearashadowfax/ScrewFast"}],"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Quick Start Guides","translations":{"de":"Schnellstartanleitungen","es":"Guías de Inicio Rápido","fa":"راهنمای شروع سریع","fr":"Guides de Démarrage Rapide","ja":"クイックスタートガイド","zh-cn":"快速入门指南"},"collapsed":false,"autogenerate":{"directory":"guides"}},{"label":"Tools & Equipment","translations":{},"collapsed":false,"items":[{"label":"Tool Guides","translations":{},"link":"tools/tool-guides/","attrs":{}},{"label":"Equipment Care","translations":{},"link":"tools/equipment-care/","attrs":{}}]},{"label":"Construction Services","translations":{},"collapsed":false,"autogenerate":{"directory":"construction"}},{"label":"Advanced Topics","translations":{},"collapsed":false,"autogenerate":{"directory":"advanced"}}],"head":[{"tag":"meta","attrs":{"property":"og:image","content":"https://screwfast.uk/social.webp"}},{"tag":"meta","attrs":{"property":"twitter:image","content":"https://screwfast.uk/social.webp"}}],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.ico","type":"image/x-icon"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"en":"ScrewFast Docs"},"isMultilingual":true,"defaultLocale":{"label":"English","lang":"en","dir":"ltr","locale":"root"},"locales":{"root":{"label":"English","lang":"en","dir":"ltr"},"de":{"label":"Deutsch","lang":"de","dir":"ltr"},"es":{"label":"Español","lang":"es","dir":"ltr"},"fa":{"label":"Persian","lang":"fa","dir":"rtl"},"fr":{"label":"Français","lang":"fr","dir":"ltr"},"ja":{"label":"日本語","lang":"ja","dir":"ltr"},"zh-cn":{"label":"简体中文","lang":"zh-CN","dir":"ltr"}}};

const project = {"build":{"format":"directory"},"root":"file:///home/braco/Escritorio/collados/","srcDir":"file:///home/braco/Escritorio/collados/src/","trailingSlash":"ignore"};
...
export { BuiltInDefaultLocale as B, stripTrailingSlash as a, getCollectionPathFromRoot as b, stripLeadingSlash as c, stripHtmlExtension as d, ensureHtmlExtension as e, ensureTrailingSlash as f, getCollectionPath as g, pickLang as h, stripLeadingAndTrailingSlashes as i, ensureLeadingSlash as j, stripExtension as k, project as p, starlightConfig as s, useTranslations as u };
