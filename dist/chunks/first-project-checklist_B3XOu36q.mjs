  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.p, {
      ...
      children: [createVNode(_components.h2, {
        id: "preparación-del-proyecto",
        children: "Preparación del Proyecto"
      }), createVNode(_components.a, {
        class: "sl-anchor-link",
        href: "#preparación-del-proyecto",
        children: [createVNode(_components.span, {
          ...
          class: "sr-only",
          children: "Sección titulada «Preparación del Proyecto»"
        })]
      })]
      ...
      children: [createVNode($$Card, {
        ...
        children: createVNode(_components.ul, {
          children: ["\n", createVNode(_components.li, {
            ...
            children: "Definir objetivos claros y criterios de éxito para la finalización del proyecto."
          }), "\n"]
        })
      }), createVNode($$Card, {
        ...
        children: createVNode(_components.ul, {
          children: ["\n", createVNode(_components.li, {
            ...
            children: "Verificar la disponibilidad y condición del inventario antes de comenzar."
          }), "\n"]
        })
      }), createVNode($$Card, {
        ...
        children: createVNode(_components.ul, {
          children: ["\n", createVNode(_components.li, {
            children: "Si se necesita experiencia adicional o mano de obra, organiza los servicios de construcción de ScrewFast con anticipación."
          }), "\n", createVNode(_components.li, {
      ...
      class: "sl-heading-wrapper level-h2",
      children: [createVNode(_components.h2, {
        id: "ejecución-del-proyecto",
        children: "Ejecución del Proyecto"
      }), createVNode(_components.a, {
        class: "sl-anchor-link",
        href: "#ejecución-del-proyecto",
        children: [createVNode(_components.span, {
          "aria-hidden": "true",
          class: "sl-anchor-icon",
          children: createVNode(_components.svg, {
          ...
          class: "sr-only",
          children: "Sección titulada «Ejecución del Proyecto»"
        })]
      })]
    }), "\n", createVNode(_components.div, {
      ...
      children: [createVNode(_components.h3, {
        ...
        children: [createVNode(_components.span, {
          ...
          class: "sr-only",
          children: "Sección titulada «Fase Inicial»"
        })]
      })]
    }), "\n", createVNode($$Steps, {
      children: createVNode(_components.ol, {
        children: ["\n", createVNode(_components.li, {
          children: ["\n", createVNode(_components.p, {
            children: "Configurar el sitio del proyecto según las pautas de configuración de ScrewFast."
          }), "\n"]
        }), "\n", createVNode(_components.li, {
          children: ["\n", createVNode(_components.p, {
            children: "Realizar una reunión inicial de equipo para alinear los objetivos del proyecto y las metodologías de ScrewFast."
          }), "\n"]
        }), "\n", createVNode(_components.li, {
          children: ["\n", createVNode(_components.p, {
...
const file = "/home/braco/Escritorio/collados/src/content/docs/es/guides/first-project-checklist.mdx";
...
Content.moduleId = "/home/braco/Escritorio/collados/src/content/docs/es/guides/first-project-checklist.mdx";
